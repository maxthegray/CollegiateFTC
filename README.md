...
* Adds new Java sample to demonstrate using a hardware class to abstract robot actuators, and share them across multiple OpModes.
  ...
  * Abstracted hardware class is [org.firstinspires.ftc.teamcode.AutonomousBot.RobotHardware.java](FtcRobotController/src/main/java/org/firstinspires/ftc/robotcontroller/external/samples/org.firstinspires.ftc.teamcode.AutonomousBot.RobotHardware.java)
