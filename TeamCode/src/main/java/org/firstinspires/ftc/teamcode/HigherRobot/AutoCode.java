...
public class AutoCode extends LinearOpMode {
    ...
    public void stage1() {
            driveStraight(0.5, 14.5, 0);
            sleep(500);
            clawServo.setPosition(0.6);
            sleep(500);
            driveStraight(0.5, -14, 0);
            sleep(100);
    }
    public void simple() {
        if (woah == 0) {
    ...
    public void stage2() {
        if (woah == 0 ) {
            ...
            sleep(500);
            driveStraight(0.4, 26, 35.5);
            sleep(250);
            clawServo.setPosition(0.1);
            sleep(500);
            turnToHeading(0.25, -90);
            sleep(500);
            driveStraight(1 , 75, -90);
            wristServo.setPosition(0.4);
            sleep(1500);
            driveStraight(1 , 25, -75);
            clawServo.setPosition(0.6);
            sleep(500);
        } else {
            turnToHeading(0.4, -35);
    ...
    public void puckGrabAndPlaceBackStage() {
    ...
    public void encoderArms(double speed,
